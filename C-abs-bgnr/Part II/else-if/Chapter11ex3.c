// Example program file 11ex3.c

/* This program asks the user their state of happiness on a scale
 * of 1 to 10 then gives a custom 2-line message based on their
 ...
 */
 ...
 int main()
 {
     ...
     // Once the user's level of happiness is entered, a series of
     // if statements test the number against decreasing numbers.
     ...
     else if (prefer >= 5)
     {
         ...
         printf("Maybe thing will get even better soon!\n");
     }
     else if(prefer >= 3)
     {
