// Example program 23ex2

/* This program searches a sorted list of customer IDs in order to get
	credit totals */
...
int main()
{
	...
	int found = 0; // Flag variable: Will be 1 (true) if customer is found
	...
	for (outer = 0; outer < 9; outer++)
	{
		...
		for (inner = outer; inner < 10; inner++)
		{
			...
			{
				tempID = custID[inner];	  // Must switch both arrays or
				tempBal = custBal[inner]; // they are no longer linked
