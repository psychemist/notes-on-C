// Example program 22ex1

/* This program takes an ID number from the user and then checks the
 * ID against a list of custmers in the database. If the customer
 * exists, it uses the array element to check their current balance,
...
int main()
{
	...
	int found = 0; // Will be 1 (true) if customer is found aka flag variable
