// Example program 29ex2

/* The program opens the file created in the first example program of the
	chapter and changes one of the letters to an '*'.
...
int main()
{
	...
	fseek(fptr, (i - 1), SEEK_SET); // Subtract 1 because array starts at 0
