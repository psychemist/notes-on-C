// Example program #2 from Chapter 17

/* This program presents a menu of choices three different decades), gets
 * user's choce, and then presents a secondary menu (sports, entertainment,
 * and politics).
 * When the user makes her second choice, it prints a list of key
 * information from that specific decade n that specific category.
 */

#include <stdio.h>
#include <stdlib.h> // Must remember to use this if you plan to use exit()
...
int main()
{
	...
	/* The top-menu choice and the switch statement that makes resulting
		info appear are encased in a do-while loop that ensures one of the
		4 menu choices are made */
	do
	{
		...
		switch (choice1)
		{
		// In the first case, the user picks the 80s
		case (1):
		{
		...
		case (3):
		{
			...
			if (choice2 == 1)
			{
				...
				printf("2008: Phialdelphia Phillies\n");
			...
			else if (choice2 == 2)
			{
				...
				printf("2007: No Coutry for Old Men\n");
